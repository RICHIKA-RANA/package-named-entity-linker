...
def create_new_fact(payload: FactCreateRequest) -> FactResponse:
    return create_fact(
...
@router.get(
    ...
    summary="List facts",
    description="Returns every fact currently registered.",
)
def get_all_facts() -> List[FactResponse]:
    return list_facts()
...
def get_fact_by_id(fact_id: str) -> FactResponse:
    result = get_fact(fact_id)
